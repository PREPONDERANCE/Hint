...
parser.add_argument(
    "--input_dir", default="./dataset", type=str, help="Directory of validation images"
)
parser.add_argument(
    "--result_dir",
    default="./results/Rain100L_HINT/",
    type=str,
    help="Directory for results",
)
parser.add_argument(
    "--weights", default="./models/Rain100L_HINT.pth", type=str, help="Path to weights"
)
